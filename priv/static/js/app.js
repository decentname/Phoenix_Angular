...
function AppController($scope, $http) {
    ...
    $scope.createUser = function () {
        $http({ method: 'POST', url: 'api/user/register/', data: { 'user': $scope.user } }).then(function successCallback(response) {
            $scope.user.email = "";
            $scope.user.password = "";
    ...
    $scope.authenticateUser = function () {
        $http({ method: 'POST', url: 'user/login/', data: { 'email': $scope.auth.email, 'password': $scope.auth.password } }).then(function successCallback(response) {
            $scope.auth.email = "";
            $scope.auth.password = "";
            window.location = '/user';
    ...
    $scope.Logout = function () {
        $http({ method: 'GET', url: 'api/user/logout/' }).then(function successCallback(response) {
            $scope.auth.email = "";
            $scope.auth.password = "";
            window.location = '/';
